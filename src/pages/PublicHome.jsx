...
export default function PublicHome() {
    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        setStats({
          ...
          totalMembers,
          topTeam: teamsWithRanking[0] || null,
  ...
  const getTopTeams = (count = 3) => {
    return teamsWithMembers.filter(team => team.rank !== null).slice(0, count)
  }
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-indigo-900/30">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 shadow-2xl mb-8 ring-2 ring-blue-500/30">
            ...
            <>
              ...
              <div className="mb-12">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                  {getTopTeams(3).map((team, index) => (
                    <div 
                      key={team.id}
                      className={`relative rounded-2xl p-6 border-2 backdrop-blur-sm ${
                        team.rank === 1 
                          ? 'md:order-2 bg-gradient-to-b from-gray-800 to-gray-900 border-amber-500/30 shadow-2xl' 
                          : 'md:order-1 bg-gradient-to-b from-gray-800/80 to-gray-900 border-gray-700 shadow-lg'
                      } ${team.rank === 3 ? 'md:order-3' : ''}`}
                    >
                      <div className="absolute -top-6 left-1/2 transform -translate-x-1/2">
                        <div className={`w-14 h-14 rounded-full flex items-center justify-center text-2xl font-bold shadow-2xl bg-gradient-to-br ${getMedalColor(team.rank)} ring-2 ring-gray-800`}>
